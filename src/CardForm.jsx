        ...
        <div className="CardForm">
            <form action="#" className="form" >
                ...
                <div className="form__group">
                    ...
                    <input type="text" className="form__input form__input--number" name="number" placeholder="e.g. 1234 5678 9123 0000" maxLength={19} value={cardInfo.number} onChange={handleChange} />
                </div>
